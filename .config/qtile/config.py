...
keys = [
    ...
    Key([mod], "w", lazy.screen.toggle_group(), desc="Toggle groups"),
    ...
    # Key([mod1], "Tab", lazy.group.next_window(), desc="Toggle focus between windows"),
    Key([mod1], "Tab", lazy.layout.next(), desc="Toggle focus between windows"),
